...
parser.add_argument('--train_path', type=str, default='./datasets/crossCulture_/train_x.csv')
parser.add_argument('--train_labels', type=str, default='./datasets/crossCulture_/train_y.csv')
parser.add_argument('--dev_path', type=str, default='./datasets/crossCulture_/dev_x.csv')
parser.add_argument('--dev_labels', type=str, default='./datasets/crossCulture_/dev_y.csv')
parser.add_argument('--test_path', type=str, default='./datasets/crossCulture_/test_x.csv')
parser.add_argument('--test_labels', type=str, default='./datasets/crossCulture_/test_y.csv')
...
def train(train_loader, test_loader):
    ...
    # Migration learning, use the parameters of the fakenews model to initialize the model parameters of crosscultural
...
def test(dev_loader):
    ...
    for x in dev_loader:
        ...
        p = torch.softmax(p, 1)
        y = p[:, 1] - p[:,
                      0]  # The probability of a label of 1 (predicted as fake news) minus the probability of a label of 0 (predicted as true news)
